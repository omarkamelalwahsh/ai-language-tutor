...
export const QUESTION_BANK: AssessmentQuestion[] = [
  ...
  // Grammar A1
  {
    ...
    skillWeights: { grammar: 1.0, vocabulary: 0.3 },
  ...
  // Vocabulary A1
  {
    ...
    skillWeights: { vocabulary: 1.0, grammar: 0.2 },
    scoringChannels: ['comprehension', 'grammar_accuracy'],
    difficulty: 'A1',
    type: 'mcq',
  ...
  // Reading A1
  {
    ...
    secondarySkills: ['vocabulary'],
    skillWeights: { reading: 1.0, vocabulary: 0.3 },
    scoringChannels: ['comprehension', 'grammar_accuracy'],
    difficulty: 'A1',
    type: 'reading_mcq',
  ...
  // Listening A1
  {
    ...
    secondarySkills: ['vocabulary'],
    skillWeights: { listening: 1.0, grammar: 0.2 },
  ...
  // Speaking A2
  {
    ...
    skillWeights: { speaking: 1.0, grammar: 0.5, vocabulary: 0.5 },
  ...
  // Writing A2
  {
    ...
    skillWeights: { writing: 1.0, grammar: 0.5, vocabulary: 0.5 },
    scoringChannels: ['task_completion', 'lexical_range', 'grammar_accuracy', 'fluency'],
    difficulty: 'A2',
    type: 'short_text',
