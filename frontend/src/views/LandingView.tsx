...
const LandingView: React.FC<LandingViewProps> = ({ onGetStarted, onSignIn }) => {
  return (
    <div className="min-h-screen bg-[#0E1015] text-[#f1f5f9] overflow-x-hidden selection:bg-indigo-500/30 font-sans relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
         ...
         <motion.div 
           ...
           className="absolute top-[20%] left-[20%] w-[50vw] h-[50vw] bg-indigo-600/30 rounded-full blur-[160px]" 
         />
      ...
      <FadeTransition className="relative z-10 flex flex-col min-h-screen">
        ...
        <nav className="w-full pt-8 px-4 flex justify-center z-50">
          <div className="w-full max-w-5xl bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-3xl px-8 py-4 flex items-center justify-between shadow-2xl">
            ...
            <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-300">
               ...
               <a href="#" className="hover:text-white transition-colors">Models & Free</a>
            </div>

            <div className="flex items-center gap-6">
              <button onClick={onSignIn} className="text-sm font-medium text-slate-300 hover:text-white transition-colors">
                Log in
              </button>
              <button onClick={onGetStarted} className="px-5 py-2.5 bg-white/10 hover:bg-white/20 text-white text-sm font-bold rounded-xl border border-white/10 transition-all backdrop-blur-md">
                Sign up
              </button>
            </div>
          </div>
        ...
        <header className="flex flex-col items-center pt-32 pb-40 px-6 text-center">
          <motion.h1 
            ...
            className="text-6xl md:text-8xl font-bold tracking-tight text-white max-w-5xl leading-[1.05]"
          >
            Master Languages <br/>
            with AI that Evolves <br/>
            <span className="text-slate-400">with You</span>
          </motion.h1>
          ...
          <motion.p 
            ...
            className="mt-8 text-xl md:text-2xl text-slate-300 max-w-2xl font-light leading-relaxed"
          >
          ...
          >
            <button 
              ...
              className="group relative px-8 py-4 bg-indigo-500 hover:bg-indigo-400 text-white text-lg font-bold rounded-2xl transition-all overflow-hidden"
            >
        ...
        {/* ── FEATURE GRID ── */}
        <section className="py-24 px-6 border-y border-white/5 bg-black/20 backdrop-blur-sm z-10">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <motion.div 
                  ...
                  className="p-10 rounded-[2.5rem] bg-white/[0.02] border border-white/10 hover:bg-white/[0.05] hover:border-white/20 transition-all flex flex-col gap-6"
                >
                  <div className={`w-16 h-16 rounded-2xl ${feature.bg} flex items-center justify-center border border-white/5 shadow-inner`}>
                    {feature.icon}
                  </div>
                  <div>
          ...
          <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-24">
            <div className="flex-1 space-y-12">
              {[
                ...
                >
                  <div className="shrink-0 w-12 h-12 bg-white/5 border border-white/10 rounded-2xl flex items-center justify-center text-indigo-400 group-hover:bg-indigo-500 group-hover:text-white transition-all shadow-sm">
                    {point.icon}
                  </div>
                  <div>
            ...
            <div className="flex-1 flex flex-col gap-8">
              <h2 className="text-4xl md:text-5xl font-black text-white leading-tight">Beyond chat practice. <br/><span className="text-indigo-400">Structured growth.</span></h2>
              ...
              <div className="pt-4">
                 <button 
                   onClick={onGetStarted}
                   className="px-8 py-4 bg-white/5 hover:bg-white/10 text-white rounded-2xl font-bold transition-all border border-white/10 inline-flex items-center gap-3 backdrop-blur-md"
                 >
        ...
        <footer className="py-24 px-6 z-10">
          <div className="max-w-5xl mx-auto rounded-[3rem] p-12 md:p-24 bg-gradient-to-br from-indigo-900/40 to-purple-900/40 text-center relative overflow-hidden backdrop-blur-xl border border-white/10 shadow-2xl">
            ...
            <div className="relative z-10 flex flex-col items-center">
              <h2 className="text-4xl md:text-6xl font-black text-white mb-8 tracking-tight leading-[1.1]">Stop Guessing. <br/>Start Mastering.</h2>
              ...
              <button 
                onClick={onGetStarted}
                className="px-12 py-6 bg-white text-indigo-900 hover:bg-indigo-50 text-xl font-bold rounded-2xl transition-all shadow-[0_0_40px_rgba(255,255,255,0.2)] hover:shadow-[0_0_60px_rgba(255,255,255,0.4)] active:scale-95"
              >
